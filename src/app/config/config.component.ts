...
export class ConfigComponent implements OnInit {
    ...
    onSubmit() {
        ...
        this.gameService.setThemeChoice(
            this.checkoutForm.get('themeChoice').value
        );
        this.gameService.setLevel(
            this.checkoutForm.get('level').value.toString()
        );
        this.gameService.setBackgroundImg(
            this.checkoutForm.get('imgChoice').value
        );
