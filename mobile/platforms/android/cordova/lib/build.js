...
function parseOpts(options, resolvedTarget, projectRoot) {
    ...
    if (options.argv.targetSdkVersion) {
        ret.extraArgs.push(
            '-PcdvTargetSdkVersion=' + options.argv.targetSdkVersion
        )
    }
    ...
    if (buildConfig) {
        ...
        if (config.android && config.android[ret.buildType]) {
            ...
            if (androidInfo.keystore && !packageArgs.keystore) {
                ...
                events.emit(
                    'log',
                    'Reading the keystore from: ' + packageArgs.keystore
                )
            }
...
module.exports.help = function () {
    ...
    console.log(
        "    '--minSdkVersion=#': Override minSdkVersion for this build."
    )
    console.log(
        "    '--maxSdkVersion=#': Override maxSdkVersion for this build. (Not Recommended)"
    )
    console.log(
        "    '--targetSdkVersion=#': Override targetSdkVersion for this build."
    )
    console.log(
    ...
    console.log('')
    console.log(
        'Signed APK flags (overwrites debug/release-signing.proprties) :'
    )
    console.log(
    ...
    console.log(
        "    '--password=': Password for the key. (Optional - prompted)"
    )
