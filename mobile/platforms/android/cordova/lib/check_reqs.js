...
module.exports.get_gradle_wrapper = function () {
    ...
    if (module.exports.isWindows()) {
        ...
        if (result.stderr.toString().length > 0) {
            var androidPath =
                path.join(process.env['ProgramFiles'], 'Android') + '/'
            ...
            if (hasJavaHome) {
                ...
                if (javacPath) {
                    ...
                    if (fs.existsSync(find_java)) {
                        ...
                        var maybeJavaHome = path.dirname(
                            path.dirname(javacPath)
                        )
                        if (
                            fs.existsSync(
                                path.join(maybeJavaHome, 'lib', 'tools.jar')
                            )
                        ) {
                    ...
                    var firstJdkDir =
                        shelljs.ls(
                            process.env['ProgramFiles'] + '\\java\\jdk*'
                        )[0] ||
