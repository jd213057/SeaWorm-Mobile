...
;(function () {
    ...
    ;(function () {
        ...
        require = function (id) {
            if (!modules[id]) {
                ...
                var cycle =
                    requireStack.slice(inProgressModules[id]).join('->') +
                    '->' +
                    id
    ...
    define('cordova', function (require, exports, module) {
        ...
        document.addEventListener = function (evt, handler, capture) {
            ...
            if (typeof documentEventHandlers[e] !== 'undefined') {
                ...
                m_document_addEventListener.call(
                    document,
                    evt,
                    handler,
                    capture
        ...
        var cordova = {
            ...
            addStickyDocumentEventHandler: function (event) {
                return (documentEventHandlers[event] = channel.createSticky(
                    event
                ))
            },
    ...
    define('cordova/argscheck', function (require, exports, module) {
        ...
        function extractParamName(callee, argIndex) {
            return /\(\s*([^)]*?)\s*\)/.exec(callee)[1].split(/\s*,\s*/)[
                argIndex
            ]
        }
        ...
        function buildPayload(payload, message) {
            ...
            if (payloadKind == 's') {
                ...
                while (multipartMessages !== '') {
                    ...
                    multipartMessages = multipartMessages.slice(
                        spaceIdx + msgLen + 1
                    )
            ...
            if (CordovaNavigator.bind) {
                for (var key in origNavigator) {
                    if (typeof origNavigator[key] === 'function') {
                        newNavigator[key] = origNavigator[key].bind(
                            origNavigator
                        )
                    } else {
                        ;(function (k) {
    ...
    define('cordova/platform', function (require, exports, module) {
        ...
        module.exports = {
            ...
            bootstrap: function () {
                ...
                var backButtonChannel = cordova.addDocumentEventHandler(
                    'backbutton'
                )
