            ...
            !(function () {
                ...
                !(function (t) {
                    ...
                    var y = { name: 'NO ZONE' },
                        ...
                        I = {
                            ...
                            showUncaughtError: function () {
                                return !a[M('ignoreConsoleErrorUncaughtError')]
                            },
                    ...
                    Zone.__load_patch('ZoneAwarePromise', function (t, e, n) {
                        ...
                        var x = a('rejectionHandledHandler')
                        function S(t) {
                            if (0 === t[d]) {
                                try {
                                    var n = e[x]
                            ...
                            l || (l = _[s] = f('ON_PROPERTY' + s)),
                                (i.set = function (t) {
                                    ...
                                    e || n !== h || (e = h),
                                        e &&
                                            (e[l] &&
                                                e.removeEventListener(s, w),
                                            u && u.apply(e, v),
                                            'function' == typeof t
                                                ? ((e[l] = t),
                                                  e.addEventListener(s, w, !1))
                                                : (e[l] = null))
                                }),
                                (i.get = function () {
                                    var t = this
                                ...
                                if (r)
                                    if (1 === r.length) l(r[0], n, e)
                                        ...
                                        for (
                                            ...
                                            (!e ||
                                                !0 !==
                                                    e.__zone_symbol__propagationStopped);
                                            i++
                                        )
                                            l(o[i], n, e)
                            }
                    ...
                    function v(e, r) {
                        ...
                        function O(t) {
                            A ||
                                ...
                                null == _.options ||
                                ((t.options = !!_.options.capture),
                                (_.options = t.options))
                        }
                        r && r.prepend && (m = y[f(r.prepend)] = y[r.prepend])
                        var T = l
                                ? function (t) {
                                      if (!_.isExisting)
                                          return (
                                    ...
                                    function () {
                                        ...
                                        if (!v || v(e, s, c, arguments)) {
                                            ...
                                            return (
                                                ...
                                                (Z.capture = p),
                                                (Z.eventName = u),
                                                f && (Z.originalDelegate = s),
                                                a ? j.unshift(Z) : j.push(Z),
                                                i ? c : void 0
                                            )
                                        }
                                    }
                ...
                function U(t, e) {
                    ...
                    n &&
                        ...
                        e.patchMethod(
                            ...
                            function (t) {
                                return function (e, n) {
                                    ;(e.__zone_symbol__propagationStopped = !0),
                                        t && t.apply(e, n)
                                }
                            }
                        )
                ...
                var B = Zone.__symbol__,
                    ...
                    K = (Object[B('getOwnPropertyDescriptor')] =
                ...
                function lt(t, e) {
                    if ((!b || k) && !Zone[t.symbol('patchEvents')]) {
                        ...
                        if (m) {
                            ...
                            ft(
                                i,
                                ut.concat(['messageerror']),
                                o ? o.concat(a) : o,
                                n(i)
                            ),
                                ft(Document.prototype, ut, o),
                                void 0 !== i.SVGElement &&
                                    ft(i.SVGElement.prototype, ut, o),
                ...
                Zone.__load_patch('util', function (n, r, a) {
                    ...
                    (function (t) {
                        t.__zone_symbol__legacyPatch = function () {
                            var e = t.Zone
                            e.__load_patch('registerElement', function (
                                t,
                                e,
                                n
                            ) {
                                ...
                                e.__load_patch('EventTargetLegacy', function (
                                    t,
                                    e,
                                    n
                                ) {
                ...
                Zone.__load_patch('legacy', function (t) {
                    ...
                    Zone.__load_patch('timers', function (t) {
                        dt(t, 'set', 'clear', 'Timeout'),
                            dt(t, 'set', 'clear', 'Interval'),
                            dt(t, 'set', 'clear', 'Immediate')
                    }),
                    ...
                    Zone.__load_patch('XHR', function (t, e) {
                        !(function (t) {
                                        ...
                                        return function (t, r) {
                                            ...
                                            if (
                                                ...
                                                if (
                                                    ...
                                                    return
                                                o.zone.cancelTask(o)
                                            } else if (!0 === e.current[m]) return w.apply(t, r)
                                        }
                                    })
                            }
                            function x(t) {
                            ...
                            function E(t) {
                                var e = t.data
                                return (
                                    (e.aborted = !0), w.apply(e.target, e.args)
                                )
                            }
                        })(t)
                        var n = f('xhrTask'),
            ...
            r('replace', 2, function (t, e, n, r) {
                ...
                return [
                    ...
                    function (t, r) {
                        ...
                        for (var x, S = '', E = 0, O = 0; O < _.length; O++) {
                            w = _[O]
                            for (
                                var T = String(w[0]),
                                ...
                                j.push(void 0 === (x = w[P]) ? x : String(x))
                            var D = w.groups
                            if (v) {
                                var R = [T].concat(j, I, h)
                                void 0 !== D && R.push(D)
                                var M = String(r.apply(void 0, R))
                            } else M = m(T, h, I, j, D, r)
                            I >= E &&
                                ((S += h.slice(E, I) + M), (E = I + T.length))
                        }
                        return S + h.slice(E)
                    },
                ]
            ...
            t.exports = function (t, e, n) {
                ...
                if (
                    ...
                    O ||
                        ...
                        (m.constructor = k)),
                        (E || T) && (w('delete'), w('has'), d && w('get')),
                        (T || S) && w(y),
                        g && m.clear && delete m.clear
                }
                return (
                    (_[t] = k),
                    r({ global: !0, forced: k != b }, _),
                    h(k, t),
                    g || n.setStrong(k, t, d),
                    k
                )
            ...
            t.exports = function (t, e, n, f, h, b, m) {
                ...
                if (
                    ...
                    if (
                        ...
                        for (w in _) (!d && !E && w in O) || s(O, w, _[w])
                    else r({ target: e, proto: !0, forced: d || E }, _)
                return _
            }
        },
        fhKU: function (t, e, n) {
            ...
            u ||
                (I(
                    (B = function () {
                        ...
                        return (
                            c && nt && rt(G, e, { configurable: !0, set: n }),
                            ot(e, t)
                        )
                    }).prototype,
                    'toString',
                ...
                B.prototype[Z] || T(B.prototype, Z, B.prototype.valueOf),
                L(B, 'Symbol'),
                (D[F] = !0)
        },
        piMb: function (t, e, n) {
