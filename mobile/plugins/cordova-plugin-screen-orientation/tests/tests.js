...
exports.defineAutoTests = function () {
    ...
    describe('window.screen.orientation', function () {
        ...
        it('should have an eventListener interface', function () {
            ...
            expect(typeof window.screen.orientation.addEventListener).toBe(
                'function'
            )

            expect(window.screen.orientation.removeEventListener).toBeDefined()
            expect(typeof window.screen.orientation.removeEventListener).toBe(
                'function'
            )
        })
    })
    ...
    describe('OrientationLockType', function () {
        ...
        it('should have defined types', function () {
            ...
            expect(
                window.OrientationLockType['portrait-secondary']
            ).toBeDefined()
            expect(
                window.OrientationLockType['landscape-primary']
            ).toBeDefined()
            expect(
                window.OrientationLockType['landscape-secondary']
            ).toBeDefined()
...
exports.defineManualTests = function (contentEl, createActionButton) {
    createActionButton('Listen to orientationchange events', function () {
        window.addEventListener('orientationchange', function () {
            contentEl.innerHTML +=
                '<p>Orientation changed! ' + screen.orientation.type + '</p>'
        })
    })
