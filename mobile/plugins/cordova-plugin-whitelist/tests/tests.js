        ...
        describe('Match function (cordova.whitelist.match) that checks URLs against patterns', function () {
            function expectMatchWithResult(result) {
                return function (url, patterns, description) {
                    description =
                        description ||
                        (result ? 'should accept ' : 'should reject ') +
                            url +
                            ' for ' +
            ...
            itShouldMatch(
                'http://www.apache.org/',
                ['*'],
                'should accept any domain for *'
            )
            itShouldNotMatch(
                'http://www.apache.org/',
                [],
                'should not accept any domain for []'
            )

            itShouldMatch('http://apache.org/', ['http://*.apache.org'])
            itShouldMatch('http://www.apache.org/', ['http://*.apache.org'])
            itShouldMatch('http://www.apache.org/some/path', [
                'http://*.apache.org',
            ])
            itShouldMatch('http://some.domain.under.apache.org/', [
                'http://*.apache.org',
            ])
            itShouldMatch('http://user:pass@apache.org/', [
                'http://*.apache.org',
            ])
            itShouldMatch('http://user:pass@www.apache.org/', [
                'http://*.apache.org',
            ])
            itShouldMatch('http://www.apache.org/?some=params', [
                'http://*.apache.org',
            ])
            itShouldNotMatch('http://apache.com/', ['http://*.apache.org'])
            itShouldNotMatch('http://www.evil.com/?url=www.apache.org', [
                'http://*.apache.org',
            ])
            itShouldNotMatch('http://www.evil.com/?url=http://www.apache.org', [
                'http://*.apache.org',
            ])
            itShouldNotMatch(
                'http://www.evil.com/?url=http%3A%2F%2Fwww%2Eapache%2Eorg',
                ['http://*.apache.org']
            )
            itShouldNotMatch('https://apache.org/', ['http://*.apache.org'])
            itShouldNotMatch('http://www.apache.org:pass@evil.com/', [
                'http://*.apache.org',
            ])
            itShouldNotMatch('http://www.apache.org.evil.com/', [
                'http://*.apache.org',
            ])

            itShouldMatch('http://www.apache.org/', [
                'http://*.apache.org',
                'https://*.apache.org',
            ])
            itShouldMatch('https://www.apache.org/', [
                'http://*.apache.org',
                'https://*.apache.org',
            ])
            itShouldNotMatch('ftp://www.apache.org/', [
                'http://*.apache.org',
                'https://*.apache.org',
            ])
            itShouldNotMatch('http://www.apache.com/', [
                'http://*.apache.org',
                'https://*.apache.org',
            ])

            itShouldMatch('http://www.apache.org/', ['http://www.apache.org'])
            itShouldNotMatch('http://build.apache.org/', [
                'http://www.apache.org',
            ])
            ...
            itShouldMatch('http://www.apache.org/foo/bar.html', [
                'http://*/foo*',
            ])
            ...
            itShouldNotMatch('http://www.apache.org/etc/foo', [
            ...
            if (cordova.platformId == 'android')
                itShouldMatch('content://www.apache.org/', [
                    '*://www.apache.org/*',
                ])
            ...
            itShouldMatch('http://www.apache.org:81/', [
                'http://www.apache.org:81/*',
            ])
            itShouldMatch('http://user:pass@www.apache.org:81/foo/bar.html', [
                'http://www.apache.org:81/*',
            ])
            itShouldNotMatch('http://www.apache.org:80/', [
                'http://www.apache.org:81/*',
            ])
            itShouldNotMatch('http://www.apache.org/', [
                'http://www.apache.org:81/*',
            ])
            itShouldNotMatch('http://www.apache.org:foo/', [
                'http://www.apache.org:81/*',
            ])
            itShouldNotMatch('http://www.apache.org:81@www.apache.org/', [
                'http://www.apache.org:81/*',
            ])
            itShouldNotMatch('http://www.apache.org:81@www.evil.com/', [
                'http://www.apache.org:81/*',
            ])
            ...
            itShouldMatch('http://www.apache.org/foo/', [
                '*://*.apache.org/foo/*',
            ])
            itShouldMatch('http://www.apache.org/foo/bar', [
                '*://*.apache.org/foo/*',
            ])
            itShouldNotMatch('http://www.apache.org/bar/foo/', [
                '*://*.apache.org/foo/*',
            ])
            itShouldNotMatch('http://www.apache.org/Foo/', [
                '*://*.apache.org/foo/*',
            ])
            itShouldNotMatch('http://www.apache.org/Foo/bar', [
                '*://*.apache.org/foo/*',
            ])
        })
        ...
        describe('Test function (cordova.whitelist.test) that checks against config.xml', function () {
            function expectTestWithResult(result) {
                return function (url, description) {
                    description =
                        description ||
                        (result ? 'should accept ' : 'should reject ') + url
